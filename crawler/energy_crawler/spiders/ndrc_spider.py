"""
国家发改委爬虫 - 使用Playwright处理JavaScript渲染
"""
import scrapy
...
class NdrcSpider(scrapy.Spider):
    ...
    def parse_article(self, response, meta):
        ...
        # 提取作者
        author = response.css('.author::text, .source::text').get()
        if author:
        ...
        if content_parts:
            ...
            for selector in ['div.TRS_Editor', 'div.content', 'div#content', 'td.b12']:
