"""
中国新能源网爬虫 - 使用Playwright处理JavaScript渲染
"""
import scrapy
...
class NewEnergySpider(scrapy.Spider):
    """中国新能源网爬虫 - 使用Playwright"""
    name = 'newenergy'
    ...
    def start_requests(self):
        ...
        urls = [
            ...
            'http://www.newenergy.org.cn/news/',
        ]
        ...
        for link in links:
            ...
            if (10 < len(title) < 100 and 
                ...
                if not href.startswith('http'):
                    if href.startswith('/'):
                        href = 'http://www.newenergy.org.cn' + href
                    else:
