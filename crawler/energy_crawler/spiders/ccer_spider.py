...
class CCERSpider(scrapy.Spider):
    """全国温室气体自愿减排交易系统爬虫"""
    name = 'ccer'
    
    allowed_domains = ['ccer.com.cn']
    start_urls = [
        'https://www.ccer.com.cn/',
    ]
    ...
    def parse(self, response):
        ...
        for link in links:
            ...
            if (title and href and 
                ...
                ('news' in href.lower() or 'article' in href.lower() or 
                 'detail' in href.lower() or '.html' in href)):
                ...
                if not href.startswith('http'):
                    if href.startswith('/'):
                        href = 'https://www.ccer.com.cn' + href
                    else:
                ...
                if articles_found >= 15:  # 限制每次最多15篇
                    break
    ...
    def parse_article(self, response):
        ...
        item['source'] = '全国温室气体自愿减排交易系统'
        item['source_url'] = response.url
        item['category'] = 'carbon_trading'
        ...
        if content_parts:
            ...
            # 尝试提取整个内容区域
            for selector in ['div.content', 'div.article', 'div.detail', 'div.news-content']:
